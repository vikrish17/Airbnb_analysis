...
#  else:
#     os.chdir(r"C:\Users\vigne\OneDrive\Documents\Airbnb_analysis")
#     df = pd.read_csv("AB_NYC_2019", encoding="ISO-8859-1")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Vignesh K"}')
    mail = (f'{"Mail :"}  {"vigneshkrishnan1798@gmail.com"}')
